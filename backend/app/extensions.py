...
def init_extensions(app):
    ...
    global mongo_client, db, users_collection, quizzes_collection, results_collection, \
           bookmarks_collection, word_pools_collection, words_in_pools_collection, vocab_lists_collection, \
           ai_client, logger
    ...
    if not api_key:
        logger.error("DEEPSEEK_API_KEY not set in environment, AI features will be disabled.")
    else:
    ...
    try:
        ...
        vocab_lists_collection = db.vocab_lists
        vocab_lists_collection = db.vocab_lists
