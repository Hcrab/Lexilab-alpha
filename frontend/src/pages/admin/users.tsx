    ...
    <main className="p-6 space-y-6">
      ...
      <section className="space-y-3">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <input className="border p-1" type="password" placeholder="password" value={form.password} onChange={e => setForm({ ...form, password: e.target.value })} />
      ...
      {edit && (
        <section className="space-y-3">
          ...
          <div className="flex flex-wrap gap-2">
            <input className="border p-1" type="password" placeholder="password" value={edit.password} onChange={e => setEdit({ ...edit, password: e.target.value })} />
